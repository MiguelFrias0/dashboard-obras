...
try:
    ...
    with tab_geral:
        if isinstance(periodo, tuple) and len(periodo) == 2:
            ...
            # GRÁFICO DIÁRIO COM DESIGNER PLOTLY
            st.markdown("---")
            ...
            fig_evol = px.area(df_chart, x=df_chart.index, y=['Recebidos', 'Despachados', 'Enviados'],
    ...
    # ==========================================
    # ABA 2: ANÁLISE INDIVIDUAL (CARDS MODERNOS)
    # ==========================================
    with tab_individual:
    ...
    # ==========================================
    # ABA 3: TIME (BARRA DE COMPARATIVO)
    # ==========================================
    with tab_time:
    ...
    # ==========================================
    # ABA 4: CAMPO (EXPANDERS ESTILIZADOS)
    # ==========================================
    with tab_campo:
